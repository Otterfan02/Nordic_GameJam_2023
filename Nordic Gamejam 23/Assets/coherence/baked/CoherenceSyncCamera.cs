...
namespace Coherence.Generated
{
	...
	public class Binding_46cd690149dfe934ebe8093c607e8d63_828d72ab_a442_49e1_9f8f_2dd8e07d66de : PositionBinding
	{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'Camera' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncCamera : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncCamera>();
			if (coherenceSync.TryGetBindingByGuid("828d72ab-a442-49e1-9f8f-2dd8e07d66de", "position", out Binding InternalWorldPosition_Translation_value))
			{
				var clone = new Binding_46cd690149dfe934ebe8093c607e8d63_828d72ab_a442_49e1_9f8f_2dd8e07d66de();
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncCamera] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
