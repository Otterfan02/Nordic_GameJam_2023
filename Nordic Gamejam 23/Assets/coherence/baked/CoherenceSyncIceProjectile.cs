...
namespace Coherence.Generated
{
	...
	public class Binding_e7a2e78b58c6f9c419ed8a30b425d810_57390024_e640_4c24_b978_0fbb6cf21c9f : PositionBinding
	{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'IceProjectile' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncIceProjectile : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncIceProjectile>();
			if (coherenceSync.TryGetBindingByGuid("57390024-e640-4c24-b978-0fbb6cf21c9f", "position", out Binding InternalWorldPosition_Translation_value))
			{
				var clone = new Binding_e7a2e78b58c6f9c419ed8a30b425d810_57390024_e640_4c24_b978_0fbb6cf21c9f();
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncIceProjectile] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
