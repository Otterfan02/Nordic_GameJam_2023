...
namespace Coherence.Generated
{
	...
	public class Binding_4148e6cce0669ed41b60f17a32cd07da_adfe562c_fcc2_422c_ae73_dfe06006d7e7 : PositionBinding
	{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'FoodSpawner' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncFoodSpawner : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncFoodSpawner>();
			if (coherenceSync.TryGetBindingByGuid("adfe562c-fcc2-422c-ae73-dfe06006d7e7", "position", out Binding InternalWorldPosition_Translation_value))
			{
				var clone = new Binding_4148e6cce0669ed41b60f17a32cd07da_adfe562c_fcc2_422c_ae73_dfe06006d7e7();
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncFoodSpawner] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
