...
namespace Coherence.Generated
{
	...
	public class Binding_381a2c25330358c48abb7579981b3e77_f52fb589_f1b5_4c45_a136_4f48d40a1a82 : PositionBinding
	{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'SkeleSpawner' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncSkeleSpawner : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncSkeleSpawner>();
			if (coherenceSync.TryGetBindingByGuid("f52fb589-f1b5-4c45-a136-4f48d40a1a82", "position", out Binding InternalWorldPosition_Translation_value))
			{
				var clone = new Binding_381a2c25330358c48abb7579981b3e77_f52fb589_f1b5_4c45_a136_4f48d40a1a82();
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncSkeleSpawner] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
