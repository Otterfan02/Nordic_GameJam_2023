...
namespace Coherence.Generated
{
	...
	public class Binding_242515ccaaf002542b0e72e5aa76db60_996e5685_ff72_48ee_a498_a247f8a6704c : PositionBinding
	{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'Chilli' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncChilli : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncChilli>();
			if (coherenceSync.TryGetBindingByGuid("996e5685-ff72-48ee-a498-a247f8a6704c", "position", out Binding InternalWorldPosition_Translation_value))
			{
				var clone = new Binding_242515ccaaf002542b0e72e5aa76db60_996e5685_ff72_48ee_a498_a247f8a6704c();
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncChilli] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
