...
namespace Coherence.Generated
{
	...
	public class Binding_d1aa71088f5cb1e49aa3feffb6bf6aa9_dae9d940_dffa_4137_8371_1fca276a3cba : PositionBinding
	{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'Dorito' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncDorito : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncDorito>();
			if (coherenceSync.TryGetBindingByGuid("dae9d940-dffa-4137-8371-1fca276a3cba", "position", out Binding InternalWorldPosition_Translation_value))
			{
				var clone = new Binding_d1aa71088f5cb1e49aa3feffb6bf6aa9_dae9d940_dffa_4137_8371_1fca276a3cba();
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncDorito] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
