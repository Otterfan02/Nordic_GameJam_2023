...
namespace Coherence.Generated
{
	...
	public struct Player_id0_PlayerScript_6943692034615545658 : ICoherenceComponentData
	{
		...
		{
			return $"Player_id0_PlayerScript_6943692034615545658(currentHeat: {currentHeat}, score: {score})";
		}
		...
		{
			var other = (Player_id0_PlayerScript_6943692034615545658)data;
			if ((mask & 0x01) != 0)
			{
				Frame = other.Frame;
		...
		public static void Serialize(Player_id0_PlayerScript_6943692034615545658 data, uint mask, IOutProtocolBitStream bitStream)
		{
		...
		{
			var mask = (uint)0;
			var val = new Player_id0_PlayerScript_6943692034615545658();
		...
		{
			var last = lastSent as Player_id0_PlayerScript_6943692034615545658?;
