...
namespace Coherence.Generated
{
	...
	public class Binding_1a31f1e946b732a47aba5db2fad6053d_dd44f8c4_4d93_4e42_8b74_d8006fa1a4e7 : PositionBinding
	{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'Skeleton' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncSkeleton : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncSkeleton>();
			if (coherenceSync.TryGetBindingByGuid("dd44f8c4-4d93-4e42-8b74-d8006fa1a4e7", "position", out Binding InternalWorldPosition_Translation_value))
			{
				var clone = new Binding_1a31f1e946b732a47aba5db2fad6053d_dd44f8c4_4d93_4e42_8b74_d8006fa1a4e7();
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncSkeleton] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
